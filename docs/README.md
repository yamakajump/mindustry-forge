...
One line per document: what it answers, so you can find the one you need without opening
all of them.

| Document | Answers |
|---|---|
| [`roadmap.md`](roadmap.md) | What already exists, how the remaining work is tiered, and what is next |
| [`blocks.md`](blocks.md) | Every block class the game has, and which ones this repository has ported |
...
| [`decisions/`](decisions/) | Why a shipped feature is the way it is, one document per decision, indexed on its own [`README.md`](decisions/README.md) |
| [`captures/`](captures/) | Screenshots the root `README.md` and `README.fr.md` embed (`fiche-bloc.png`, `rapport-analyse.png`) |
